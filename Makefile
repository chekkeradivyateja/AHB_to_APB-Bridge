...
VSIMCOV= -coverage -sva:browse tabnew
...
help:
	...
	@echo "! run_test1	=>  clean, compile & run the simulation for single_trans in batch mode.			!" 
	@echo "! run_test2	=>  clean, compile & run the simulation for incr_trans in batch mode.			!"
	@echo "! run_test3	=>  clean, compile & run the simulation for ram_even_addr_test in batch mode.			!" 
	@echo "! view_wave1 =>  To view the waveform of single_trance_test	    						!" 
	@echo "! view_wave2 =>  To view the waveform of incr_trance_test	    						!" 
